...
source_sherpa() {
    ...
    export LD_LIBRARY_PATH=${base}/${LCG}/fastjet/3.4.3/${platform}/lib:$LD_LIBRARY_PATH
    export LD_LIBRARY_PATH=${base}/${LCG}/MCGenerators/openloops/2.1.3p2/${platform}/lib:$LD_LIBRARY_PATH
    export LD_LIBRARY_PATH=${base}/${LCG}/MCGenerators/openloops/2.1.3p2/${platform}/proclib:$LD_LIBRARY_PATH
    export LD_LIBRARY_PATH=${base}/${LCG}/MCGenerators/lhapdf/6.5.5/${platform}/lib:$LD_LIBRARY_PATH
    ...
    export LD_LIBRARY_PATH=${base}/${LCG}/MCGenerators/sherpa/3.0.1p2.openmpi3/${platform}/lib:$LD_LIBRARY_PATH
    export LD_LIBRARY_PATH=${base}/${LCG}/MCGenerators/sherpa/3.0.1p2.openmpi3/${platform}/lib64/SHERPA-MC:$LD_LIBRARY_PATH

    # Add Sherpa with mpirun capabilities to PATH
    export PATH=${base}/${LCG}/MCGenerators/sherpa/3.0.1p2.openmpi3/${platform}/bin:$PATH
    export CPLUS_INCLUDE_PATH=${base}/${LCG}/MCGenerators/sherpa/3.0.1p2.openmpi3/${platform}/include/SHERPA-MC:$CPLUS_INCLUDE_PATH
    # Specify LHAPDF path and the OpenLoops prefix
    export LHAPDF_DATA_PATH=$LHAPDF_DATA_PATH:${base}/${LCG}/MCGenerators/lhapdf/6.5.5/${platform}/share/LHAPDF:/cvmfs/sft.cern.ch/lcg/external/lhapdfsets/current
    export OL_PREFIX=${base}/${LCG}/MCGenerators/openloops/2.1.3p2/${platform}/
