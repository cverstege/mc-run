...
from .Sherpa3Build import Sherpa3Build, Sherpa3Config

logger = get_logger(__name__)


class Sherpa3Integrate(GenRivetTask):
    """
    ...
    def requires(self):
        return {
            ...
            "Sherpa3Build": Sherpa3Build.req(self),
        }
    ...
    def run(self):
        ...
        work_dir = os.path.abspath(self.input()["Sherpa3Config"].parent.path)
        ...
        try:
            ...
            run_file = os.path.join(work_dir, "Sherpa.yaml")
            sherpack_includes = []
            sherpack_includes.append(os.path.join(work_dir, "Results.zip"))
            sherpack_includes.append(os.path.join(work_dir, "References.tex"))
